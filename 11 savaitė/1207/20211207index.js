...
const imgReverse = document.querySelector("#reverse");
const buttons = document.querySelectorAll("button");
const winnerIs = document.querySelector(".border");
...
function generateCards(id, player) {
...
function generateOneCard(id, player) {
